...
- **Casting:** Built-in identity; exempt from project casting.
...
**Project:** uberos
A Docker Compose-based ROS and simulator environment delivered through a browser workspace with noVNC, browser-based VS Code, terminals, and multi-screen pop-out support.
